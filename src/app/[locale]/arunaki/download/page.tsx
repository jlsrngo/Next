...
export default function ArunakiDownloadPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#09090b] text-zinc-900 dark:text-zinc-100 selection:bg-zinc-200 dark:selection:bg-zinc-800 transition-colors font-sans antialiased flex flex-col justify-between">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-14 sm:pt-20 pb-20 space-y-14 w-full flex-1">
        {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Windows Setup */}
          <div className="p-6 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 flex flex-col justify-between space-y-5 shadow-sm">
            <div className="space-y-3 font-mono">
              <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">
                {isId ? 'Direkomendasikan' : 'Recommended'}
              </span>
              <h2 className="font-bold text-base text-black dark:text-white">Windows Setup (.exe)</h2>
              <p className="text-xs text-zinc-500">Arunaki-Setup-x64.exe</p>
              <ul className="text-xs space-y-1.5 text-zinc-600 dark:text-zinc-400 font-sans pt-1">
          ...
          {/* Windows Portable */}
          <div className="p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between space-y-5">
            <div className="space-y-3 font-mono">
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-400">
                {isId ? 'Portabel' : 'Standalone'}
              </span>
              <h2 className="font-bold text-base text-black dark:text-white">Windows Portable (.zip)</h2>
          ...
          <div className="p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between space-y-5">
            <div className="space-y-3 font-mono">
              ...
              <h2 className="font-bold text-base text-black dark:text-white">macOS Universal (.dmg)</h2>
        ...
        <div className="p-6 sm:p-8 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/60 space-y-4">
          <div className="flex items-center gap-2">
            <Terminal className="w-5 h-5 text-zinc-600 dark:text-zinc-400" />
            <h2 className="font-bold text-base text-black dark:text-white font-mono">
          ...
          <div className="p-4 rounded bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 font-mono text-xs text-zinc-800 dark:text-zinc-200 space-y-2">
            <div>
          ...
          <div className="pt-2 flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 font-mono text-xs font-semibold hover:opacity-90 transition-opacity"
            >
